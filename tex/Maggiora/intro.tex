...
We are expecting to find some correlations related to information,
spreading and entropy.\\
This work needs a phenomenological approach as often described in
ABM's literature: we will start from real world observation trying
to find hidden behaviours.\\
This model is not yet validated with real data. Further details
may emerge from a real analysis using real data gathered, eg,
from social media. Once found how to connect the model with
real data it will be possible to improve and put into practice
what was studied.