\begin{abstract}
  \noindent Agent-based models (ABMs) have been widely used for
  ...
  Rumor spreading in social networks is a natural environment where
  ABMs could explain complex phenomena like echo chambers.
  ...
  We developed a network framework where agents interact with
  each other.
